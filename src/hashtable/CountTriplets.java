...
public class CountTriplets { // Complete the countTriplets function below.
    static long countTriplets(List<Long> arr, long r) {
        long total = 0;
        Map<Long, Long> count = new HashMap<Long, Long>(); // count of ints
        Map<Long, Long> tuplets = new HashMap<Long, Long>(); // map 2nd -> count of links
